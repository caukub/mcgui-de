...
### I want a Vanilla server {#what-vanilla}
...
It is important to have a [server backup](../administration/backups.md#backups) in case something would go wrong or you want to revert the change.
